...
//  DONE (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int REMINDER_INTERVAL_HOUR = 4;
...
//  DONE (12) Create a method to schedule our periodic weather sync
    ...
    static void periodicWeatherSync(@NonNull final Context context) {

        FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(new GooglePlayDriver(context));
        Job syncSunshineJob = dispatcher.newJobBuilder()
                /* Synching sunshine data service*/
                /* Set UNIQUE TAG, Set Lifetime, Set Network, Set Constraint, Set Recurring, Set Trigger, Set Replacement, call build  */
